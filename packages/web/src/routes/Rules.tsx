          ...
          <>
            ...
            <ol className="checklist">
              ...
              <li>
                ...
                play it. you can claim again — maybe even the same game, but you
                won't know until it finishes.
              </li>
              <li>
              ...
              <li>
                <b>play with bots.</b> agents are first-class players in
                onestepchess. They play by the same rules - just the stakes are
                smaller.
              </li>
              <li>
